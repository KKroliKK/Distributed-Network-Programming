...
class RegistryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.register = channel.unary_unary(
                ...
                response_deserializer=chord__pb2.IdReply.FromString,
                )
        self.deregister = channel.unary_unary(
                '/Registry/deregister',
                request_serializer=chord__pb2.Id.SerializeToString,
                response_deserializer=chord__pb2.BoolReply.FromString,
                )
        self.populate_finger_table = channel.unary_unary(
                '/Registry/populate_finger_table',
                request_serializer=chord__pb2.Id.SerializeToString,
                response_deserializer=chord__pb2.PopFingTableRep.FromString,
                )
        ...
        self.get_ack = channel.unary_unary(
                '/Registry/get_ack',
                request_serializer=chord__pb2.Empty.SerializeToString,
                response_deserializer=chord__pb2.ServerType.FromString,
                )
...
def add_RegistryServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'register': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=chord__pb2.IdReply.SerializeToString,
            ),
            'deregister': grpc.unary_unary_rpc_method_handler(
                    servicer.deregister,
                    request_deserializer=chord__pb2.Id.FromString,
                    response_serializer=chord__pb2.BoolReply.SerializeToString,
            ),
            'populate_finger_table': grpc.unary_unary_rpc_method_handler(
                    servicer.populate_finger_table,
                    request_deserializer=chord__pb2.Id.FromString,
                    response_serializer=chord__pb2.PopFingTableRep.SerializeToString,
            ),
            ...
            'get_ack': grpc.unary_unary_rpc_method_handler(
                    servicer.get_ack,
                    request_deserializer=chord__pb2.Empty.FromString,
                    response_serializer=chord__pb2.ServerType.SerializeToString,
            ),
    }
...
class Registry(object):
    ...
    def deregister(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Registry/deregister',
            ...
            chord__pb2.BoolReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def populate_finger_table(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Registry/populate_finger_table',
            chord__pb2.Id.SerializeToString,
            chord__pb2.PopFingTableRep.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def get_ack(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Registry/get_ack',
            chord__pb2.Empty.SerializeToString,
            chord__pb2.ServerType.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
...
class NodeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.save_to_pred = channel.unary_unary(
                '/Node/save_to_pred',
                request_serializer=chord__pb2.Ids.SerializeToString,
...
def add_NodeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'save_to_pred': grpc.unary_unary_rpc_method_handler(
                    servicer.save_to_pred,
                    request_deserializer=chord__pb2.Ids.FromString,
...
class Node(object):
    ...
    def save_to_pred(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Node/save_to_pred',
            chord__pb2.Ids.SerializeToString,
    ...
    def get_ack(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Node/get_ack',
            chord__pb2.Empty.SerializeToString,
            chord__pb2.ServerType.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
